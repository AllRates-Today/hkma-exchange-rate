...
Official **Hong Kong Monetary Authority** (Hong Kong) daily exchange rates in Node.js / TypeScript — 17 currencies against the HKD, with history back to 1981. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/hkma/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — no credit card required.
